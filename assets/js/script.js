// GLOBAL INTERACTIVITY HELPER: This file powers theme toggles, navigation, modals, analytics tracking, and other site-wide behaviors.
'use strict';

/*
 * BEGINNER OVERVIEW: This self-contained function listens for clicks on the sun/moon toggle button,
 * remembers the visitor's choice in localStorage when possible, and keeps the button label accurate.
 * It also hides the toggle after scrolling down a bit so it doesn’t cover content while reading.
 */
/* -------------------------------------------------------------------------- */
/*  Color mode toggle                                                         */
/* -------------------------------------------------------------------------- */
(function initColorModeToggle() {
  ...
  // FRIENDLY NOTE: We test whether localStorage is available (private browsing can block it) before using it.
  ...
  const getStoredMode = function () {
    ...
    // FALLBACK PLAN: If nothing is saved, lean on the user's OS color preference.
...
/*
 * BEGINNER OVERVIEW: The next function powers the "Back to top" button.
 * It quietly watches how far someone has scrolled, shows the button after a few screen heights,
 * and scrolls smoothly (or instantly if reduced motion is preferred) when clicked.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * QUICK HELPER LIBRARY: The small functions below keep repeated tasks tidy, like toggling classes
 * or temporarily disabling links that shouldn’t be clickable yet. You can reuse them anywhere on the site.
 */
/* -------------------------------------------------------------------------- */
/*  Utility helpers                                                           */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: The testimonials carousel opens a modal so visitors can read each story in detail.
 * We copy the avatar, headline, and text into the modal, and provide keyboard support plus an overlay to close it.
 */
/* -------------------------------------------------------------------------- */
/*  Testimonials modal                                                        */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: Blog cards can lead to internal write-ups or external articles.
 * This section keeps Google Analytics informed when someone clicks, ensures disabled cards stay inactive,
 * and wires up fallbacks for cards that use the shared project template.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: Learning hub cards behave a lot like portfolio cards.
 * The code below tracks clicks for analytics, respects disabled states on the blog page,
 * and opens external toolkits in a new tab when provided.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: The lightbox lets visitors enlarge any eligible image, zoom in,
 * and drag it around on desktop or touch devices. It’s created once, then reused for every picture.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: Portfolio filters work with both the button row and the custom select dropdown.
 * When filters change, we show matching project cards, update the dropdown label, and send analytics for clicks.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: The contact form handler validates fields live, sends submissions to Formspree,
 * and shows a friendly success or error message without reloading the page.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: Visitors can swap between different gallery layouts (like masonry or two-column).
 * These listeners add the chosen layout class and highlight the active button.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: The navigation controller remembers the last open tab, restores scroll position,
 * and keeps sessionStorage clean so single-page navigation feels seamless across reloads.
 */
/* -------------------------------------------------------------------------- */
...
/*
 * BEGINNER OVERVIEW: Long-form pages (like project or blog templates) use sticky side navigation.
 * The code below syncs the active section highlight as you scroll and handles smooth scrolling to anchors.
 */
/* -------------------------------------------------------------------------- */
